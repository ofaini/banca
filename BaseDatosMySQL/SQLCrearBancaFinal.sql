...
insert into cliente(id_cliente,nombre_cliente,clave_cliente) values('1','Sergio Medina',sha1('123456'));
insert into cliente(id_cliente,nombre_cliente,clave_cliente) values('2','Luisa Lane',sha1('654321'));
...
insert into administrador(id_administrador,nombre_administrador,clave_administrador) values('1','Administrador General',sha1('123456'));